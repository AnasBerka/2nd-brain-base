---
tags:
  - Logging/Daily/2026/05
Creation date: 2026/05/05 08:07
week:
  - 2026-W19
cssclasses:
  - daily
...
***
### ✍️ New tasks
- [ ] 📝 Morning check about everything & cleaning the house + organize everything correctly ⏲️ 07:00 - 07:45 ⏬ 📅 2026-05-05 
- [ ] 📝 Logging the daily activities in Obsidian for the [[00 - Main vault/Notes/Daily Notes/2026/05/2026-05-04|previous day]] about everything  ⏲️  07:45 - 08:00 📅 2026-05-05 ⏬ 

***
### 🔔 Upcoming events (this month)
```tasks
(tag includes #Logging/SDay/BDay) OR (tag includes #RIP ) OR (tag includes #SDay)
scheduled in 2026-05-04 2026-06-04
sort by status
sort by priority 
sort by scheduled 
sort by description ASC
...
let pages = dv.pages('"00 - Main vault/Notes/Daily Notes"')
	.filter(p => p.file.name <= "2026-05-05" )
...
const pages = dv.pages('"00 - Main vault/Notes/Daily Notes"')
  .where(p => p.file.day <= dv.date("2026-05-05"))
...
***
### Links
=> [[00 - Main vault/Notes/Daily Notes/2026/05/2026-05-04|View previous day]]
=> [[00 - Main vault/Notes/Weekly reports/2026/2026-W19|View the weekly report]]
